...
if __name__ == "__main__":
    ...
    system_prompt_filepath = f"src/thrall_lib/data/prompts/system/{problem_name}.md"
    sample_conversation_filepath = f"src/thrall_lib/data/prompts/conversation/{problem_name}.md"
